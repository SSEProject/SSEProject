...
<asp:UpdatePanel ID="updatePanel" runat="server" UpdateMode="Conditional">                 
   ...
   <asp:Timer runat="server" ID="Countdown_Timer" Interval="5000" ontick="Countdown_Timer_Tick"></asp:Timer>
         ...
         <asp:ImageButton   width="70" height="70" ID="ButtonDelete" OnClick="buttonDelete_Click" runat="server" ImageUrl="\Resources\Images\delete_icon.png" ToolTip="Delete Task" ImageAlign="AbsMiddle"/>
           ...
           <asp:SqlDataSource ID="TestDB" runat="server" ConnectionString="Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Z:\SSE\Git\Git\SSEProject\SSEProject\Resources\ToDoList.accdb;Persist Security Info=True;Jet OLEDB:Database Password=123456" ProviderName="System.Data.OleDb" SelectCommand="SELECT * FROM [Items]">
           </asp:SqlDataSource>
